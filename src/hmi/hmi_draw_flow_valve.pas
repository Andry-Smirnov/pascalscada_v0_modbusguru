...
procedure THMICustomFlowValve.AddNotifyCallback(WhoNotify: IColorChangeNotification);
begin

end;

procedure THMICustomFlowValve.RemoveNotifyCallback(WhoRemove: IColorChangeNotification);
begin
...
procedure THMICustomFlowValve.Notification(AComponent: TComponent; Operation: TOperation);
begin
...
procedure THMICustomFlowValve.ValveStateNeedsComponentState(var CurState: TComponentState);
begin
