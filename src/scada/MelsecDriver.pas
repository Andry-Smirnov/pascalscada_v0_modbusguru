...
(*
As vari�veis poss�veis de serem utilizadas no CLP mitsubishi com protocolo "MC Protocol" para series Q/L s�o as seguintes:
Mem�rias outputs: M, SM, L, F, V, X, Y, B
Mem�rias registros: D, SD
...
begin
  ...
  //cada tipo de fun��o de leitura/escrita
  //
